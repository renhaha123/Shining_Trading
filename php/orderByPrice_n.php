   ...
   <div id="middle">
	 ...
	 <div id="need_content">
	   <?php
         ...
         $result2=mysql_query("select * from need_goods inner join user_info on need_goods.user_id=user_info.user_id where flag=1 order by price desc limit ".($n-1)*$pageSize.",".$pageSize,$conn);//创建结果集
